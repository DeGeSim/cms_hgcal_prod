...
process.MINIAODSIMoutput = cms.OutputModule(
    ...
    dataset=cms.untracked.PSet(
        dataTier=cms.untracked.string("MINIAODSIM"), filterName=cms.untracked.string("")
    ),
...
process.DQMoutput = cms.OutputModule(
    "DQMRootOutputModule",
    dataset=cms.untracked.PSet(
        dataTier=cms.untracked.string("DQMIO"), filterName=cms.untracked.string("")
    ),
...
process.Flag_trackingFailureFilter = cms.Path(
...
process.Flag_EcalDeadCellBoundaryEnergyFilter = cms.Path(
...
process.validation_step7 = cms.EndPath(
    (
        process.TauValNumeratorAndDenominatorQCD
        + process.TauValNumeratorAndDenominatorRealData
        + process.TauValNumeratorAndDenominatorRealElectronsData
        + process.TauValNumeratorAndDenominatorRealMuonsData
        + process.TauValNumeratorAndDenominatorZEE
        + process.TauValNumeratorAndDenominatorZMM
        + process.TauValNumeratorAndDenominatorZTT
    )
)
...
process.schedule = cms.Schedule(
    ...
    process.validation_step12,
    process.validation_step13,
    process.validation_step14,
